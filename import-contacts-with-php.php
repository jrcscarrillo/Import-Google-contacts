...
//Declare your Google Client ID, Google Client secret and Google redirect uri in  php variables
        $google_client_id = '195376246355-u45jntbq89vp3q3sbnoc8v1ndjrb6uct.apps.googleusercontent.com';
        $google_client_secret = '4D0EgNlxEyxIH4DG1mCANRym';
        $google_redirect_uri = 'https://republicaecuatoriana.ecuadoraurora.club/import-contacts-with-php.php';
...
//google response with contact. We set a session and redirect back
        ...
        if (isset($_SESSION['google_code'])) {
            ...
            if (!empty($google_contacts)) {
                ...
                foreach ($google_contacts as $contact) {
                    ...
                    $registro = new \republica\contactos();
                    $_SESSION['contactos'] = array();
                    $registro->genLimpia_contactos();
                    $_SESSION['contactos']['name'] = $contact['name'];
                    $_SESSION['contactos']['email'] = $contact['email'];
                    $estado = $registro->adiciona_contactos($db);
                    echo '<tr>';
    ...
    <div class="container">
        <div class="row">
            <br><br><br>
            <div class="col-lg-12">
                This page is a practical example on how to import google contacts. This is related with the following article 
                <br>
